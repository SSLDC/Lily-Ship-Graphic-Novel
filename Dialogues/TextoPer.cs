...
public class TextoPer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        teclas=GameObject.Find("Teclas").GetComponent<Image>();
    ...
    void Update()
    {
        ...
        if (num == 6) teclas.gameObject.SetActive(true);
        else if (num > 6) teclas.gameObject.SetActive(false);
